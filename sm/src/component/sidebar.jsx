  ...
  return (
    ...
    >
      ...
      <ul className="nav nav-pills flex-column mb-auto">
        ...
        <li onClick={() => {setSelectedTab("Slab")} }>
          <a href="#" className={`nav-link link-body-emphasis ${selectedTab === "Slab" && "active"}`}>
            <svg className="bi pe-none me-2" width="16" height="16">
        ...
        <li onClick={() => {setSelectedTab("File Upload")} }>
          <a href="#" className={`nav-link link-body-emphasis ${selectedTab === "File Upload" && "active"}`}>
            <svg className="bi pe-none me-2" width="16" height="16">
